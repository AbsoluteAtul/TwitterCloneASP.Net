Twitter clone web application created with C# ASP.NET.

*Creates a database automatically with EntityFrameworkCore.
...
*A user can only log in with correct credebtials.
